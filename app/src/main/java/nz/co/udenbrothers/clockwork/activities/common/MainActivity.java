...
import nz.co.udenbrothers.clockwork.util.WaitingDialogHelper;
...
public abstract class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected WaitingDialogHelper waitingDlg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        waitingDlg = new WaitingDialogHelper(this);
    ...
    */
    ...
    protected final void logout(){
        Profile.logout();
        ((App)getApplication()).dropAllTables();
    }
    ...
    protected final void alert(int messageId){
